...
const UpdateArts = () => {
  ...
  const updateMyArt = (e) => {
    ...
    fetch(`https://https://crafty-canvas-server-tau.vercel.app/${_id}`, {
      method: "PUT",
      headers: {
      ...
      >
        ...
        <div className="flex items-center lg:flex-row flex-col gap-9">
          <div className="space-y-1 text-sm w-full">
            ...
            >
              <option defaultValue={subcategory_Name} value={subcategory_Name}>
                {subcategory_Name}
              </option>
        ...
        <div className="flex items-center lg:flex-row flex-col gap-9">
          <div className="space-y-1 text-sm w-full">
            ...
            <select
              ...
              className="border border-gray-700 p-3 rounded-lg w-full"
            >
              <option defaultValue={customization} value={customization}>
                {customization}
              </option>
